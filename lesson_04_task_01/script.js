...
console.log(getExpensesMonth(1500, 1000));


// Задание №2
function getAccumulatedMonth(income, expense) {
let accumulation = income - expense;
return accumulation;
}

console.log(getAccumulatedMonth(5000, 3000));

// Задание №3
let accumulatedMonth = getAccumulatedMonth(5000, 3000);
